...
function processFile(elm) {
    ...
    var bw_old = document.getElementById("upload.width").value;
    ...
    reader.onload = (event) => {
        ...
        img.onload = () => {
            ...
            var buffer = new Uint8Array(16 + 8 + bw * bh * (128 * 128 * 4 + 8));
            ...
            for (var by = 0; by < bh; by++) {
                for (var bx = 0; bx < bw; bx++) {
                    ...
                    pos += 3;
                    buffer[pos++] = 128;
                    var block = ctx.getImageData(bx * 128, by * 128, 128, 128).data;
                    for (var bi = 0; bi < (128 * 128 * 4); bi++) {
            ...
            var header = new Uint8Array(4 + 4 + 1);
            pos = 0;
            header[pos++] = 0x4d;
            header[pos++] = 0x49;
            header[pos++] = 0x45;
